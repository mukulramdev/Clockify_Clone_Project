  ...
  <PopoverContent>
    ...
    <Button onClick={handlelogout}>Logout</Button>
      ...
      <div className="bottomSec" style={{ background: "" }}>
        <div className="blue"></div>
        <div
          style={{ background: "", width: isOpen ? "200px" : "63px" }}
          className="sidebar"
        >
          {
            <>
        ...
        <div className="bottomRight">
          <div className="boxes">
            ...
            <div className="box2">
              <Center height="50px">
                <button
                  style={{ width: "40%", background: "", paddingLeft: "20%" }}
                >
