...
import {
    AiOutlinePlusCircle,AiFillAndroid,AiFillApple,AiFillChrome,AiFillWindows
}from "react-icons/ai";
...
<button style={{width:"40%",background:"",paddingLeft:'20%'}}><div className='icongrp'>< BsTag/></div></button>
<Divider orientation='vertical' />
<button style={{width:"40%",background:"",paddingLeft:'20%'}}><div className='icongrp'><TbCurrencyDollar/></div></button>
<Divider orientation='vertical' />
<div style={{width:"",marginTop:"10px",marginLeft:"10px"}}><strong>00:00:00</strong></div>
                <Button bg='#03A9F4'  variant='solid' fontSize="13px" size="xs" mt="12px" ml='20px' borderRadius="5px" w='4%' color='white'>Start</Button>
                <Menu  >
<MenuButton bg='' w='10px'  _hover={{bg:'white'}} as={Button} rightIcon={<BiDotsVerticalRounded/>} fontSize="25px" mt='10px'>
